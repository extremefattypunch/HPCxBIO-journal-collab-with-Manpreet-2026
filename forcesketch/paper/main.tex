...
% If SIMBIOCHEM II turns out to be double-blind, swap the two lines below.
% \author{Anonymous submission}
\author{%
  Ian Poon\\
  Department of Cellular and Molecular Biology\\
  Harvard University\\
  \texttt{ian\_poon@fas.harvard.edu}%
}
\date{}
...
on any of four systems, and a concentrated head-space spectrum is not the reason --- the spectrum is
close to isotropic, so the limit is simply estimator variance at small $K$.
